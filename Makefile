...
all: main.o input_output.o comparison_swap.o general_func.o
	g++  $(CFLAGS) main.o input_output.o comparison_swap.o general_func.o -o main.exe
...
comparison_swap.o: $(FILE)comparison_swap.cpp
	$(CC) $(CFLAGS) -c $(FILE)comparison_swap.cpp

general_func.o: $(FILE)general_func.cpp
	$(CC) $(CFLAGS) -c $(FILE)general_func.cpp
